  ...
  return (
    <div className="h-full flex flex-col p-8 space-y-8 max-w-[1600px] mx-auto">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h2 className="text-4xl font-bold tracking-tight bg-gradient-to-r from-primary via-blue-400 to-purple-600 bg-clip-text text-transparent flex items-center gap-3">
            Creative Studio
          ...
          <p className="text-muted-foreground mt-2 text-lg max-w-2xl">
            Advanced AI content generation suite. Select a tool to begin your production.
          </p>
        </div>
